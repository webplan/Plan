...
public class DeleteFriend {
    public DeleteFriend(String account, String token, String friendAccount, final SuccessCallback successCallback, final FailCallback failCallback) {
        ...
        String actionURL = Config.SERVER_URL + Config.ACTION_DELETE_FRIEND + Config.SERVER_ACTION_SUFFIX;
